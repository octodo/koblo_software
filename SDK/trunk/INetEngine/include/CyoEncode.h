...
public:
    // Base16 Encoding
    static unsigned long Base16EncodeGetLength( unsigned long size );
    static unsigned long Base16Encode( void* dest, const void* src, unsigned long size );

    // Base32 Encoding
    static unsigned long Base32EncodeGetLength( unsigned long size );
    static unsigned long Base32Encode( void* dest, const void* src, unsigned long size );

    // Base64 Encoding
    static unsigned long Base64EncodeGetLength( unsigned long size );
    static unsigned long Base64Encode( void* dest, const void* src, unsigned long size );
};
