...
class CInterpolateLinar : public virtual IInterpolate
{
public:
	CInterpolateLinar();
	virtual ~CInterpolateLinar();

	// IOscillatorLOT overrides
	virtual void	Destroy();
	virtual void	SetLOT(const float* pfLOT, const int iSize);
	virtual float	Get(const float fIndex);
