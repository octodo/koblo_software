...
class CConverterLog : public virtual CConverter
{
public:
	CConverterLog(tint32 iParmMin, tint32 iParmMax, tuint iStrength);
	virtual ~CConverterLog();
	...
	//! CConverter override
	virtual tuint GetStrength() const {return miStrength;}
