...
/*! \class
 * \brief Implementation of the part of IContext which is OSX specific
*/
class CContextOSX : public virtual CContext
{
public:
	//! Constructor
	CContextOSX();
	...
	//! IContext override
	virtual void CContextOSX::SelectWindow(void* pWnd);
	//! IContext override
	virtual void CloseWindow(void* pWnd);

	virtual void OnMenuEventHandler(tint32 iData1, tint32 iData2);
...
protected:
	virtual void DoCreateMenuItem(const MenuRef& Ref, const SMenuItemList* pList, tint32& riMenuID, const std::string& sName);
