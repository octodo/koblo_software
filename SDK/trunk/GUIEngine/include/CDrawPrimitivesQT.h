...
/*! \class CDrawPrimitivesQT
 * \brief QuickTime Implementation of IDrawPrimitives
*/
class CDrawPrimitivesQT : public virtual IDrawPrimitives
{
public:
	//! Constructor
	CDrawPrimitivesQT();
	//! Destructor
	virtual ~CDrawPrimitivesQT();
