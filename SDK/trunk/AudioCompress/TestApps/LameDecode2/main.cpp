// LameDecode2 - main.cpp
// Modified for Lame /mp3 - edited only 3 lines

// Original comment from ogg/vorbis distribution:
/********************************************************************
*                                                                  *
...
// We have to include stdafx.h here or Visual Studio will vomit - XCode will ignore contents
#include "stdafx.h"
...
int main (int argc, char * const argv[]) {
	...
	if (bSyntaxErr) {
		fprintf(stderr, "Syntax: LameDecode <ogg-file> <wave-file> [<bits> [<channels>]]\n");
	...
	CAutoDelete<IDecoder> decoder(ac::ILameDecoder::Create());
