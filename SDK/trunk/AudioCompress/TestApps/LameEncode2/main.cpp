// LameEncode2 - main.cpp
// Lasse: This is now a LAME mp3 encoder - I changed 3 lines...

//The following comment came from the ogg/vorbis demo code:
/********************************************************************
*                                                                  *
...
int main (int argc, char * const argv[]) {
	...
	CAutoDelete<k2s::ac::IEncoder> encoder(k2s::ac::ILameEncoder::Create());
	...
	if (bSyntaxErr) {
		fprintf(stderr, "Syntax: LameEncode <wave-file> <mp3-file> [<quality> [<channels>]]\n\n");
