...
# get the list of example program source files from the gui-dev directories

$(eval $(call search_program_group,GUI_DEV))

# get the list of daemon program source files from the daemons directories

$(eval $(call search_program_group,DAEMONS))
