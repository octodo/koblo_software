...
$(OUTPUT_TOOLS_DEV_DIR)/%$(EXE) : $(OUTPUT_OBJ_DIR)/%.o
	@echo "LINKING tool-dev: $(notdir $<)"
	@$(LINK.cpp) $(LINK_FLAGS) $(LDFLAGS) -o $(OUTPUT_TOOLS_DEV_DIR)/$*$(EXE) $< -L$(OUTPUT_LIB_DIR) $(PROJECT_LDLIB) $(LDLIBS) $(LDLIBS_PACKAGES)
...
$(OUTPUT_GUI_DEV_DIR)/%$(EXE) : $(OUTPUT_OBJ_DIR)/%.o
	@echo "LINKING gui-dev: $(notdir $<)"
	@$(LINK.cpp) $(LINK_FLAGS) $(LDFLAGS) $(LINK_FLAGS_GUI) -o $(OUTPUT_GUI_DEV_DIR)/$*$(EXE) $< -L$(OUTPUT_LIB_DIR) $(PROJECT_LDLIB) $(LDLIBS) $(LDLIBS_PACKAGES) $(LDLIBS_GUI)
...
$(OUTPUT_DAEMONS_DIR)/%$(EXE) : $(OUTPUT_OBJ_DIR)/%.o
	@echo "LINKING daemon: $(notdir $<)"
	@$(LINK.cpp) $(LINK_FLAGS) $(LDFLAGS) -o $(OUTPUT_DAEMONS_DIR)/$*$(EXE) $< -L$(OUTPUT_LIB_DIR) $(PROJECT_LDLIB) $(LDLIBS) $(LDLIBS_PACKAGES)
