...
target_suffix_platform_dirs=$(wildcard $(call suffix_platform_dirs,$(1),$(PLATFORM_DIRS),$(LIB_DIRS)) $(call suffix_platform_dirs,$(1)$(PROJECT_VARIANT_DIR_SUFFIX),$(PLATFORM_DIRS),$(LIB_DIRS)))
...
# and for shared libs
SHLIB_COMPILE_FLAGS+=$$(SHLIB_COMPILE_FLAGS_$(1))

# set the platform specific project pre-process flags
PREPROCESS_FLAGS+=$$(PREPROCESS_FLAGS_$(1))

# and for shared libs
SHLIB_PREPROCESS_FLAGS+=$$(SHLIB_PREPROCESS_FLAGS_$(1))
