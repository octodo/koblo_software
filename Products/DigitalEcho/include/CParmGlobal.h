...
// Forwards
class CDigitalEchoPlugIn;

class CParmGlobal : public virtual de::IParameter
{
public:
	CParmGlobal(CDigitalEchoPlugIn* pPlugIn, tint32 iID, tint32 iMinValue, tint32 iMaxValue, tint32 iValue = 0);
