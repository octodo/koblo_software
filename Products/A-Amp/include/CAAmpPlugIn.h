...
class CAAmpPlugIn : public virtual CBasePlugIn, public virtual IBaseDezipperCallback
{
public:
	CAAmpPlugIn(CAAmpModule* pModule, tuint32 uiProcessIndex);
...
protected:
	...
	*/
	...
	{
		CParmGlobal* pParmGlobal = new CParmGlobal(dynamic_cast<CAAmpPlugIn*>(this), iParmID, iParmMin, iParmMax, iParmDefault);
