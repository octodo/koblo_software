...
class CKSDSP : public virtual CBaseDSPEngine
{
public:
	//! Constructor
	CKSDSP(CKSPlugIn* pPlugIn);
...
//	CBuffer* mpBufferMix;
	...
	//! Max 8 meters for all tracks/busses/AUXes (7.1 surround) (note: mix meter array part of struct unused because CKSDSP handles already)
