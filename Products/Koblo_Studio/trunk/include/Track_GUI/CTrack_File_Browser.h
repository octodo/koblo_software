...
class CTrack_Files;
//class CTrack_Regions;

class CTrack_File_Browser : public virtual CBasePane
{
public:
	CTrack_File_Browser(CBasePane* pPaneParent, CBaseGUI* pGUI);

	virtual ~CTrack_File_Browser();
	...
	*/
	...
	virtual ge::IScrollPane* GetScrollPane();
	
protected:

	CTrack_Files* mpTrack_Files;
