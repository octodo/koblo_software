...
class CMix_AUX_Insert : public virtual CBasePane
{
public:
	CMix_AUX_Insert(CBasePane* pPaneParent, CBaseGUI* pGUI);

	virtual ~CMix_AUX_Insert();
...
protected:
	...
	ge::IPopupMenu::SMenuItemList mpInput_Menu;
	ge::IPopupMenu::SMenuItemList mMenuMono;
	ge::IPopupMenu::SMenuItemList mMenuStereo;
	virtual void PreparePopups();
	ge::IDropDownListBox* CreatePop( tint32 iControlID, tint32 iBitmapID,  const ge::IPopupMenu::SMenuItemList& List, ge::SPos Pos, ge::SSize Size, ge::SRGB rRGB);


	ge::IDropDownListBox* mpInput;

	volatile tint32 miInPreparePopups_volatile;
};
