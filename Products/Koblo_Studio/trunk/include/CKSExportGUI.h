...
class CKSExportGUI : public virtual CKSBaseGUI, public virtual ge::IEventReceiver, public virtual ITimerCallback
{
public:
	CKSExportGUI(CKSPlugIn* pPlugIn, de::IParameterManager* pParmMan);

	virtual ~CKSExportGUI();
