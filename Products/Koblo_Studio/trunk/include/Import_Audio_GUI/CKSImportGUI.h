...
class CKSImportGUI : public virtual CKSBaseGUI, public virtual ge::IEventReceiver, public virtual ITimerCallback
{
public:
	CKSImportGUI(CKSPlugIn* pPlugIn, de::IParameterManager* pParmMan);

	virtual ~CKSImportGUI();
