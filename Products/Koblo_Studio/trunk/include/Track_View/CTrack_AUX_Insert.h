...
class CTrack_AUX_Insert : public virtual CBasePane
{
public:
	CTrack_AUX_Insert(CBasePane* pPaneParent, CBaseGUI* pGUI);

	virtual ~CTrack_AUX_Insert();
	virtual void Init();
	//! SetInfo
	/*!
...
//	ge::IDropDownListBox* CreatePop( tint32 iControlID, tint32 iBitmapID,  const ge::IPopupMenu::SMenuItemList& List, ge::SPos Pos, ge::SSize Size);
