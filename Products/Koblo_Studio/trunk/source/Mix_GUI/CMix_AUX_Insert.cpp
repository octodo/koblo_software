...
void CMix_AUX_Insert::Init()
{
	...
	//-----------------------------------------
	// Echo
	CreateKnob(giCtrl_Mix_AUX1Send + miCtrl_Offset, IDB_Dial_Aux, ge::SPos(17, 20), 129);
	// Reverb
	CreateKnob(giCtrl_Mix_AUX2Send + miCtrl_Offset, IDB_Dial_Aux, ge::SPos(17, 84), 129);
	//-----------------------------------------
	// Channel In
	PreparePopups();
	...
	CreateButton(miCtrl_Offset + giCtrl_Mix_Edit_Insert1, IDB_Button_Edit_Plugin, ge::SPos(116, 48));
	CreateButton(miCtrl_Offset + giCtrl_Mix_Edit_Insert2, IDB_Button_Edit_Plugin, ge::SPos(116, 48 + 16));
	CreateButton(miCtrl_Offset + giCtrl_Mix_Edit_Insert3, IDB_Button_Edit_Plugin, ge::SPos(116, 48 + 16 * 2));
	CreateButton(miCtrl_Offset + giCtrl_Mix_Edit_Insert4, IDB_Button_Edit_Plugin, ge::SPos(116, 48 + 16 * 3));
	...
	CreatePop(giCtrl_Mix_Insert_Pop1 + miCtrl_Offset, IDB_Button_Invisible_16_64, List, ge::SPos(64, 48), ge::SSize(61, 15), ge::SRGB(204,204,204));
	CreatePop(giCtrl_Mix_Insert_Pop2 + miCtrl_Offset, IDB_Button_Invisible_16_64, List, ge::SPos(64, 48 + 16), ge::SSize(61, 15), ge::SRGB(204,204,204));
	CreatePop(giCtrl_Mix_Insert_Pop3 + miCtrl_Offset, IDB_Button_Invisible_16_64, List, ge::SPos(64, 48 + 16 * 2), ge::SSize(61, 15), ge::SRGB(204,204,204));
	CreatePop(giCtrl_Mix_Insert_Pop4 + miCtrl_Offset, IDB_Button_Invisible_16_64, List, ge::SPos(64, 48 + 16 * 3), ge::SSize(61, 15), ge::SRGB(204,204,204));
}
...
void CMix_AUX_Insert::ConnectControls()
{
	...
	RegisterGlobalControlWithX3Translation(miSection, giCtrl_Mix_AUX1Send + miCtrl_Offset, giParam_ChAUX1, 4);
	RegisterGlobalControlWithX3Translation(miSection, giCtrl_Mix_AUX2Send + miCtrl_Offset, giParam_ChAUX2, 4);
	RegisterGlobalControl(miSection, giCtrl_Mix_Insert_Pop1 + miCtrl_Offset, giParam_ChInsert1);
	RegisterGlobalControl(miSection, giCtrl_Mix_Insert_Pop2 + miCtrl_Offset, giParam_ChInsert2);
	RegisterGlobalControl(miSection, giCtrl_Mix_Insert_Pop3 + miCtrl_Offset, giParam_ChInsert3);
	RegisterGlobalControl(miSection, giCtrl_Mix_Insert_Pop4 + miCtrl_Offset, giParam_ChInsert4);
}

void CMix_AUX_Insert::EventValueChange(ge::IControl* pControl, tint32 iValueNew)
{
	if (pControl->GetID() == giCtrl_Mix_Insert_Pop1 + miCtrl_Offset ||
		pControl->GetID() == giCtrl_Mix_Insert_Pop2 + miCtrl_Offset ||
		pControl->GetID() == giCtrl_Mix_Insert_Pop3 + miCtrl_Offset ||
		pControl->GetID() == giCtrl_Mix_Insert_Pop4 + miCtrl_Offset) {
		if (iValueNew != 0) {
	...
	if (pControl->GetID() == miCtrl_Offset + giCtrl_Mix_Edit_Insert1) {
		gpApplication->GetPlugInManager()->OpenGUI(miID, 0);
	}
	else if (pControl->GetID() == miCtrl_Offset + giCtrl_Mix_Edit_Insert2) {
		gpApplication->GetPlugInManager()->OpenGUI(miID, 1);
	}
	else if (pControl->GetID() == miCtrl_Offset + giCtrl_Mix_Edit_Insert3) {
		gpApplication->GetPlugInManager()->OpenGUI(miID, 2);
	}
	else if (pControl->GetID() == miCtrl_Offset + giCtrl_Mix_Edit_Insert4) {
