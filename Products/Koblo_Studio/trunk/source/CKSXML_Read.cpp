...
CKSXML_Read::CKSXML_Read(CKSPlugIn * pKSPlugIn)
{
...
CKSXML_Read::~CKSXML_Read()
{
	
}
void CKSXML_Read::ReadOnlineXML( std::string str)
{
...
void CKSXML_Read::Parse_Root( TiXmlNode* pParent )
{
...
void CKSXML_Read::Set_Project(TiXmlNode* pParent)
{
	if ( !pParent ) return ;
	printf("--------------------------  PROJECT ----------------------------\n");
...
void CKSXML_Read::Parse_Project_Childs(TiXmlNode* pParent)
{
...
void CKSXML_Read::Ignore_Tag(TiXmlNode* pParent)
{
//	printf(".\n");
	if ( !pParent ) return;
...
void CKSXML_Read::Set_Branch(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Settings(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Signature(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Update_Signature(TiXmlElement* pParent)
{
	if ( !pParent ) return;
...
void CKSXML_Read::Set_Edditing(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Loop(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Windows(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Window(TiXmlNode* pParrent, tint32 iId)
{
...
void CKSXML_Read::Set_Window_Pos(TiXmlNode* pParrent, tint32 iId)
{
	TiXmlElement* pElement = pParrent->ToElement();
...
void CKSXML_Read::Set_Window_Size(TiXmlNode* pParrent, tint32 iId)
{
	TiXmlElement* pElement = pParrent->ToElement();
...
void CKSXML_Read::Set_Dialogs(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Export_Dialog(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Sample(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Sample_Take(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
	...
	for ( pChild = pElement->FirstChild(); pChild != 0; pChild = pChild->NextSibling()) {
		...
		if(pChild->Type() == TiXmlNode::ELEMENT){
			...
			if (stricmp("in", pChild->Value()) == 0) {
				...
				Set_Track_Out(pChild->ToElement());
				...
				Set_Track_Region(pChild->ToElement());
...
void CKSXML_Read::Set_Track_In(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Track_Out(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Track_Aux(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Track_Region_Fade(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Bus(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Bus_Out(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Bus_Aux(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Bus_Insert(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Master(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Master_Aux_Return(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Master_Insert(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Master_Out(TiXmlElement* pElement)
{
	if ( !pElement ) return ;
...
void CKSXML_Read::Set_Param( TiXmlNode* pParent, tuint uiType, tuint32 iParamID, tint iSection,  tfloat fFactor)
{
	if ( !pParent ) return;
