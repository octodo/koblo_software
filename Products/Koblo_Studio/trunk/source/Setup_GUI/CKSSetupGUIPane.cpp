...
CKSSetupGUIPane::CKSSetupGUIPane(CBasePane* pPaneParent, CBaseGUI* pGUI)
...
void CKSSetupGUIPane::ConnectControls()
{
...
void CKSSetupGUIPane::OnTimer(tint32 iTimerID)
{
}

void CKSSetupGUIPane::SendMsgFromTop(SMsg* pMsg)
{
	switch(pMsg->iOpcode) 
	{
		case MsgGUIData:{
...
void CKSSetupGUIPane::ThatDidntWork()
{
...
void CKSSetupGUIPane::UpdateGUIData(tint32 iID, tint32 iValue)
{
}

ge::IDropDownListBox* CKSSetupGUIPane::CreatePop( tint32 iControlID, tint32 iBitmapID,  const ge::IPopupMenu::SMenuItemList& List, ge::SPos Pos, ge::IPane* pPane)
{
	// Resources
...
void CKSSetupGUIPane::InitAudioDevicePopupValues()
{
/*	if (mbMenuInited) {
		return;
	}*/
...
void CKSSetupGUIPane::InitAudioDevicePopupValuesInput()
{
	// Don't set DSP values - Avoid error dialog on invalid values
	//mbBlockSetAudioDevice = true;
...
void CKSSetupGUIPane::Prepare_Popups()
{
/*
...
void CKSSetupGUIPane::SetupDevice()
{
...
void CKSSetupGUIPane::SetupDeviceAsio()
{
