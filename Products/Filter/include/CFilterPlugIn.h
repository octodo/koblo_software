...
class CFilterPlugIn : public virtual CBasePlugIn, public virtual IBaseDezipperCallback
{
public:
	CFilterPlugIn(CFilterModule* pModule, tuint32 uiProcessIndex);

	virtual ~CFilterPlugIn();
...
protected:
	...
	*/
	...
	{
		CParmGlobal* pParmGlobal = new CParmGlobal(dynamic_cast<CFilterPlugIn*>(this), iParmID, iParmMin, iParmMax, iParmDefault);
