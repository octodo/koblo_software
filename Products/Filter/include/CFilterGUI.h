...
class CFilterGUI : public virtual CBaseGUI, public virtual ge::IEventReceiver
{
public:
	CFilterGUI(CFilterPlugIn* pPlugIn, de::IParameterManager* pParmMan);
	...
	CFilterPlugIn* GetPlugIn() {return dynamic_cast<CFilterPlugIn*>(mpPlugIn);}

	//! Overload
	const CFilterPlugIn* GetPlugIn() const {return dynamic_cast<const CFilterPlugIn*>(mpPlugIn);}
