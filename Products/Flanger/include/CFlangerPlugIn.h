...
class CFlangerPlugIn : public virtual CBasePlugIn, public virtual IBaseDezipperCallback
{
public:
	CFlangerPlugIn(CFlangerModule* pModule, tuint32 uiProcessIndex);

	virtual ~CFlangerPlugIn();
...
protected:
	...
	*/
	...
	{
		CParmGlobal* pParmGlobal = new CParmGlobal(dynamic_cast<CFlangerPlugIn*>(this), iParmID, iParmMin, iParmMax, iParmDefault);
