...
class CFlangerGUI : public virtual CBaseGUI, public virtual ge::IEventReceiver
{
public:
	CFlangerGUI(CFlangerPlugIn* pPlugIn, de::IParameterManager* pParmMan);
	...
	CFlangerPlugIn* GetPlugIn() {return dynamic_cast<CFlangerPlugIn*>(mpPlugIn);}

	//! Overload
	const CFlangerPlugIn* GetPlugIn() const {return dynamic_cast<const CFlangerPlugIn*>(mpPlugIn);}
