...
class CDPhaserPlugIn : public virtual CBasePlugIn, public virtual IBaseDezipperCallback
{
public:
	CDPhaserPlugIn(CDPhaserModule* pModule, tuint32 uiProcessIndex);

	virtual ~CDPhaserPlugIn();
...
protected:
	...
	*/
	...
	{
		CParmGlobal* pParmGlobal = new CParmGlobal(dynamic_cast<CDPhaserPlugIn*>(this), iParmID, iParmMin, iParmMax, iParmDefault);
