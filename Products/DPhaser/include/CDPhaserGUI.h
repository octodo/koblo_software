...
class CDPhaserGUI : public virtual CBaseGUI, public virtual ge::IEventReceiver
{
public:
	CDPhaserGUI(CDPhaserPlugIn* pPlugIn, de::IParameterManager* pParmMan);
	...
	CDPhaserPlugIn* GetPlugIn() {return dynamic_cast<CDPhaserPlugIn*>(mpPlugIn);}

	//! Overload
	const CDPhaserPlugIn* GetPlugIn() const {return dynamic_cast<const CDPhaserPlugIn*>(mpPlugIn);}
