...
class CBitCrunchGUI : public virtual CBaseGUI, public virtual ge::IEventReceiver
{
public:
	CBitCrunchGUI(CBitCrunchPlugIn* pPlugIn, de::IParameterManager* pParmMan);

	virtual ~CBitCrunchGUI();
	...
	CBitCrunchPlugIn* GetPlugIn() {return dynamic_cast<CBitCrunchPlugIn*>(mpPlugIn);}

	//! Overload
	const CBitCrunchPlugIn* GetPlugIn() const {return dynamic_cast<const CBitCrunchPlugIn*>(mpPlugIn);}
