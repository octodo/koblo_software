...
class CBitCrunchPlugIn : public virtual CBasePlugIn, public virtual IBaseDezipperCallback
{
public:
	CBitCrunchPlugIn(CBitCrunchModule* pModule, tuint32 uiProcessIndex);

	virtual ~CBitCrunchPlugIn();
...
protected:
	...
	*/
	...
	{
		CParmGlobal* pParmGlobal = new CParmGlobal(dynamic_cast<CBitCrunchPlugIn*>(this), iParmID, iParmMin, iParmMax, iParmDefault);
