...
CRhythmComposerDSP::CRhythmComposerDSP()
	: muiChannels(0)
{
...
void CRhythmComposerDSP::Destroy()
{
	delete dynamic_cast<CRhythmComposerDSP*>(this);
}

void CRhythmComposerDSP::Start()
{
...
void CRhythmComposerDSP::Stop()
{
}

void CRhythmComposerDSP::SetMaxBufferSize(tint32 uiMaxBufferSize)
{
	CBaseDSPEngine::SetMaxBufferSize(uiMaxBufferSize);
}

void CRhythmComposerDSP::SetSampleRate(tuint32 uiSampleRate)
{
	muiSampleRate	=	uiSampleRate;
	CBaseDSPEngine::SetSampleRate(uiSampleRate);
}

void CRhythmComposerDSP::SetChannels(tuint32 uiChannels)
{
	muiChannels = uiChannels;
}

void CRhythmComposerDSP::ProcessMono(float** ppfOut, const float** ppfIn, long lC)
{
...
void CRhythmComposerDSP::ProcessStereo(float** ppfOut, const float** ppfIn, long lC)
{
...
void CRhythmComposerDSP::Process(tfloat** ppfSamplesOut, const tfloat** ppfSamplesIn, tuint32 iNrOfSamples)
{
	if (muiChannels == 1) {
...
/*
void CRhythmComposerDSP::Set_Bypass(tbool bBypass)
{
	mbBypass = bBypass;
}
*/
void CRhythmComposerDSP::Set_Delay_Time(tint32 iMSec)
{
	miMSec = iMSec;
...
void CRhythmComposerDSP:: Set_Feedback(tint32 iFeedback)
{
	mfFeedback = iFeedback * 0.008f;
}

void CRhythmComposerDSP::Set_LF_Damping(tint32 iLF_Damping)
{
...
void CRhythmComposerDSP::Set_HF_Damping(tint32 iHP_Damping)
{
	if (iHP_Damping == 31) {
		mfHPDamping = 0;
	}
...
void CRhythmComposerDSP::Set_Sync_To_Tempo(tbool bSync)
{
	mbSyncToHost = bSync;
...
void CRhythmComposerDSP::Set_Delay_in_Samples()
{
	tint32 iSampleRate = muiSampleRate;
	miDelayTime = miMSec * iSampleRate / 1000;
}

void CRhythmComposerDSP::Set_Mix(tint32 iMix)
{
