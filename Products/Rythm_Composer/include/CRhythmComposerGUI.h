...
class CRhythmComposerGUI : public virtual CBaseGUI, public virtual ge::IEventReceiver
{
public:
	CRhythmComposerGUI(CDigitalEchoPlugIn* pPlugIn, de::IParameterManager* pParmMan);

	virtual ~CRhythmComposerGUI();
