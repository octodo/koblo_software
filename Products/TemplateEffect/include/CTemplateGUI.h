...
class CTemplateGUI : public virtual CBaseGUI, public virtual ge::IEventReceiver
{
public:
	CTemplateGUI(CTemplatePlugIn* pPlugIn, de::IParameterManager* pParmMan);

	virtual ~CTemplateGUI();
	...
	CTemplatePlugIn* GetPlugIn() {return dynamic_cast<CTemplatePlugIn*>(mpPlugIn);}

	//! Overload
	const CTemplatePlugIn* GetPlugIn() const {return dynamic_cast<const CTemplatePlugIn*>(mpPlugIn);}
