...
class CKVerbPlugIn : public virtual CBasePlugIn, public virtual IBaseDezipperCallback
{
public:
	CKVerbPlugIn(CKVerbModule* pModule, tuint32 uiProcessIndex);

	virtual ~CKVerbPlugIn();
...
protected:
	...
	*/
	...
	{
		CParmGlobal* pParmGlobal = new CParmGlobal(dynamic_cast<CKVerbPlugIn*>(this), iParmID, iParmMin, iParmMax, iParmDefault);
