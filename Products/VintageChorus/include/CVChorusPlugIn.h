...
class CVChorusPlugIn : public virtual CBasePlugIn, public virtual IBaseDezipperCallback
{
public:
	CVChorusPlugIn(CVChorusModule* pModule, tuint32 uiProcessIndex);

	virtual ~CVChorusPlugIn();
...
protected:
	...
	*/
	...
	{
		CParmGlobal* pParmGlobal = new CParmGlobal(dynamic_cast<CVChorusPlugIn*>(this), iParmID, iParmMin, iParmMax, iParmDefault);
