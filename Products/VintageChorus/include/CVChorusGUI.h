...
class CVChorusGUI : public virtual CBaseGUI, public virtual ge::IEventReceiver
{
public:
	CVChorusGUI(CVChorusPlugIn* pPlugIn, de::IParameterManager* pParmMan);
	...
	CVChorusPlugIn* GetPlugIn() {return dynamic_cast<CVChorusPlugIn*>(mpPlugIn);}

	//! Overload
	const CVChorusPlugIn* GetPlugIn() const {return dynamic_cast<const CVChorusPlugIn*>(mpPlugIn);}
